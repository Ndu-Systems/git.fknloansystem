...
$pdf->SetFont('Arial','B',16);
 // Header columns 
$pdf->Cell(30,20,'LoanId',1,0,'C'); 
$pdf->Cell(40,20,'LoanAmount',1,0,'C');
$pdf->Cell(20,20,'Interest',1,0,'C');
$pdf->Cell(45,20,'AdditionalLoan',1,0,'C');
$pdf->Cell(40,20,'Loan-Paid',1,0,'C');
$pdf->Cell(40,20,'Interst-Paid',1,0,'C');
$pdf->Cell(40,20,'Defaulted',1,0,'C');
$pdf->Cell(40,20,'Balance',1,0,'C');
//$pdf->Cell(20,20,'WOI',1,0,'C');

//$pdf->Cell(50,20,'Reciever',1,0,'C');
//$pdf->Cell(50,20,'Referrer',1,1,'C');
$pdf->Cell(80,20,'Description',1,0); 
$pdf->Cell(80,20,'Date',1,1); 
// End header columns
...
$pdf->Cell(30,20,$row['LoanId'],1,0,'C'); 
$pdf->Cell(40,20,$row['LoanAmount'],1,0,'C'); 
$pdf->Cell(20,20,$row['Interest'],1,0,'C');
$pdf->Cell(45,20,$row['AdditionalLoan'],1,0,'C'); 
$pdf->Cell(40,20,$row['PayedAmount'],1,0,'C'); 
$pdf->Cell(40,20,$row['PaidInterest'],1,0,'C');
$pdf->Cell(40,20,$row['DefaultedInterest'],1,0,'C');
$pdf->Cell(40,20,$row['Balance'],1,0,'C');
//$pdf->Cell(20,20,$row['WOI'],1,0,'C');

//$pdf->Cell(50,10,$row['Reciever'],1,0,'C');
//$pdf->Cell(50,10,$row['Referrer'],1,1,'C');
$pdf->Cell(80,20,$row['Description'],1,0);
$pdf->Cell(80,20,$row['LoanDate'],1,1);
